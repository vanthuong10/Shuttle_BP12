...
int main(void)
{
  ...
  /*
   * Priority task default
   * Auto task-------------osPriorityNormal3
   * Manual task-----------osPriorityNormal3
   * inforUpdatetask-------osPriorityNormal2
   * displayTaskHandle-----osPriorityNormal1
   * StartMongooseTask-----------osPriorityNormal
   * DataEthTask-----------osPriorityAboveNormal
   * IOTaskHandle----------osPriorityAboveNormal1
   * hydraulicTaskAttr-----osPriorityAboveNormal2
   * safetyTaskHandle------osPriorityAboveNormal3
   * qrTask----------------osPriorityISR
   */
  displayInit();
  databaseInit();
  sensorTaskInit();
  ...
  /* Create the thread(s) */
  /* creation of mongooseTask */
  mongooseTaskHandle = osThreadNew(StartMongooseTask, NULL, &mongooseTask_attributes);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : PG10 PG0 PG1 */
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_5
                          |GPIO_PIN_9|GPIO_PIN_12|GPIO_PIN_6;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
